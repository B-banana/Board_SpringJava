			...
			<div class="card shadow">
				<div class="card-body">
					...
					<div class="form-group">
						<!-- enctype="multipart/form-data" : 첨부파일을 서버로 전달 -->
					...
					<div class="form-group">
						...
						<form:input path="content_file" class="form-control" accept="image/*"/>
					</div>
					<div class="form-group">
...
<!-- Spring version 3.1까지는 이미지처리에 CommonsMultipartResolver 와 CosMultipartResolver 두가지 사용
지금 현재는 StandardServletMutipartResolver를 사용
 -->
